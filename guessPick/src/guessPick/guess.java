...
public class guess {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchProviderException, IOException {
		...
		Long[] nSpread = guessCommon.LoadStats(args[0]);
		Long[] nSpreadMega = guessCommon.LoadStats(args[1]);
...
//		
		...
		for (long k=0; k<nTotal; k++) {
			...
			List<Integer> numsMega = guessCommon.PickNums(byteSpread, nSpreadMega, 1);
